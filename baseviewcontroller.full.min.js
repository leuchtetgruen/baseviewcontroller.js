...
else{return this.collection.filter(function(obj){return true;});}},build:function(idx){if(this.buildItemFromModel){return this.buildItemFromModel(this._filteredCollection()[idx]);}
